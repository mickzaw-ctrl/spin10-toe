...
print(f"\nData 2025 (Infyearsion end of 2025):")
...
print(f"\nSpin(10) predictions:")
print(f"  n_s (inflation) = {SPIN10['n_s_infyearsion']}")
...
# Porownania
n_s_diff = abs(SPIN10['n_s_infyearsion'] - n_s_data) / n_s_err
print(f"\nCOMPARISON:")
