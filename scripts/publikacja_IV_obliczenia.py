...
print(f"  -> Masa z kondensatu pola gauge Spin(10)")
...
print("="*72)
print(f"{'Predykcja':<35} | {'Model':<14} | {'Eksperyment':<18} | Kryt.")
print("-"*72)
...
print(f"{'Kształt bispektrum':<35} | {0.7*100:.0f}% eq+{0.3*100:.0f}% loc | CMB-S4          | ★★")
...
# =================================================================
print("\n" + "="*72)
print(" DWA NAJSILNIEJSZE TESTY NAJBLIŻSZYCH 10 LAT")
print("="*72)
...
print(f"Publ. II      (v3.0) + Riemanna + Weyla + dS + Holografia")
