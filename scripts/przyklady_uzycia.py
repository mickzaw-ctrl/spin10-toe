"""
Przykłady użycia SHZSpin10QuantumEngine v8.0
=============================================
Kompletna kolekcja przykładów demonstrujących różne aspekty silnika.
"""
...
def example_1_basic_simulation():
    ...
    print("\n" + "="*60)
    print("PRZYKŁAD 1: Podstawowa symulacja")
    print("="*60)
...
def example_2_inflation_predictions():
    """Przykład 2: Predykcje inflacji α-Attractor"""
    print("\n" + "="*60)
...
def example_3_sgwb_spectrum():
    """Przykład 3: Widmo SGWB (trzy źródła)"""
    print("\n" + "="*60)
    print("PRZYKŁAD 3: SGWB - Trzy źródła")
    print("="*60)
...
def example_4_remedies():
    """Przykład 4: 5 kluczowych remedies"""
    print("\n" + "="*60)
...
def example_5_full_tests():
    """Przykład 5: Pełen zestaw testów"""
    print("\n" + "="*60)
    print("PRZYKŁAD 5: Pełen zestaw testów eksperymentalnych")
    print("="*60)
    ...
    print(f"   τ(p->e+π⁰) = {tests['proton_decay_HyperK']['tau_e_pi0']:.2e} lat")
...
def example_6_full_report():
    """Przykład 6: Pełen raport z symulacji"""
    print("\n" + "="*60)
    print("PRZYKŁAD 6: Pełen raport")
    print("="*60)
...
def example_7_custom_graph():
    """Przykład 7: Własna konfiguracja grafu"""
    print("\n" + "="*60)
    print("PRZYKŁAD 7: Własna konfiguracja grafu")
    print("="*60)
    
    # Duża sieć z silnym target k
    engine = SHZSpin10QuantumEngine(N=500, k_target=6, alpha=2.0, beta=2.0)
    engine.run_simulation(n_steps=1000)
    
    obs = engine.compute_observables()
    print(f"\nDuża sieć (N=500, k=6, α=2, β=2):")
    print(f"  Var(k) = {obs['Var_k']:.4f}")
...
def example_8_plot_results():
    """Przykład 8: Podstawowa wizualizacja"""
    print("\n" + "="*60)
    ...
    print(f"\nHistoria symulacji ({len(history['Var_k'])} punktow):")
